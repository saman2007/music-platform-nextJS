  ...
  return (
    <MusicListContainer title={title}>
      {musics && musics.length !== 0 ? (
        musics.map((music, index) => (
          ...
          >
            <div className="flex-grow items-center flex justify-start gap-x-[10px] overflow-hidden">
              ...
              <MusicInfos
                singerPage={music.singerPage}
                musicPage={music.musicPage}
        ...
        <h2 className="w-full flex justify-center items-center text-white text-[20px]">
          no musics with your selected filters!
        </h2>
      )}
    </MusicListContainer>
  );
