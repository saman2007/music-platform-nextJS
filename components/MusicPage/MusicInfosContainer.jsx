...
const MusicInfosContainer = (props) => {
  ...
  return (
    <div className="relative w-full min-h-[300px] rounded-[20px] grid mb-[10px] bg-[#0d0d0d] p-[5px] grid-cols-[repeat(5,auto)_100px] grid-rows-[100px_repeat(5,auto)] sm:grid-cols-[repeat(5,auto)_300px] sm:grid-rows-[repeat(6,auto)]">
